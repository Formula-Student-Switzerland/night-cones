...
\begin{table}[h!]
    ...
    \ReqItemMM{R:Time}{The cone runs for the estimated time of a skidpad or acceleration event}{$\qty{4}{\hour}$}{N/A}
...
\begin{table}[h!]
    ...
    \ReqItem{R:Mass}{The additional mass must not pose an significantly increased danger. }
    \end{ReqTable}
\end{table}
