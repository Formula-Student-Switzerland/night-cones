...
\subsubsection{Software shut-down not working}
The software shut-down does not work, because the voltage that is generated on the \ac{MOSFET} Q10 is insufficient to shut down the \qty{5.2}{\volt} converter. This reduction in voltage is caused by the voltage divider that is formed with the resistors R9 and R110. R9 can not be removed, as it is essential for allow automated testing of the shutdown circuit. The resistor R110 is replaced with a schottky diode 1N5819WS. 
